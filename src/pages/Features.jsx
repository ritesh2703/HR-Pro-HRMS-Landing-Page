...
const Features = () => {
  ...
  className="px-8 py-3 bg-indigo-800 text-white font-medium rounded-xl hover:bg-indigo-900 transition-colors duration-300 shadow-lg flex items-center justify-center gap-2"
>
  Get Started
